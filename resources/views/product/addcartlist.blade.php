                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <input name="price" class="form-check-input me-1 fs-1 w-75"
                                                type="number" value=""min="0" required>
                                        </li>
                                        <li class="list-group-item">
                                            <label class="form-check-label fs-1" for="fourthCheckbox">
                                                顯示狀態
                                            </label>
                                        ...
                                        <li class="list-group-item" style="height: 300px">
                                            ...
                                            <hr>
                                            <textarea name="desc" id="" class="w-100" style="resize: none; min-height:150px;"></textarea>
                                        </li>
                                    </ul>
